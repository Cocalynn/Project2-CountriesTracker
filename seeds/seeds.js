...
const countries = 
    [
        ...
        { cid: "BA", name: "Bosnia and Herzegovina", visitedTimes: 0, plannedTimes: 0 },
        ...
        { cid: "TL", name: "East Timor (Timor Timur)", visitedTimes: 0, plannedTimes: 0},
        ...
        { cid: "KN", name: "Saint Kitts and Nevis", visitedTimes: 0, plannedTimes: 0},
        { cid: "LC", name: "Saint Lucia", visitedTimes: 0, plannedTimes: 0 },
        { cid: "VC", name: "Saint Vincent and the Grenadines", visitedTimes: 0, plannedTimes: 0 },
        { cid: "WS", name: "Samoa", visitedTimes: 0, plannedTimes: 0 },
        { cid: "SM", name: "San Marino", visitedTimes: 0, plannedTimes: 0 },
        { cid: "ST", name: "Sao Tome and Principe", visitedTimes: 0, plannedTimes: 0 },
        ...
        { cid: "CS", name: "Serbia and Montenegro", visitedTimes: 0, plannedTimes: 0 },
